...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   convert_itoa_ulonglong.c                           :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hebernar <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/04 14:51:16 by hebernar          #+#    #+#             */
/*   Updated: 2019/10/04 14:51:17 by hebernar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char		*ft_end(unsigned long long nb, char *ret, t_pf *stct, int i)
{
	int k;
...
static char		*ft_middle(unsigned long long nb, char *ret, t_pf *stct, int i)
{
	int j;
...
static char		*ft_begin(unsigned long long nb, char *ret, t_pf *stct, int i)
{
