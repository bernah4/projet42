...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   convert_itoa_uchar.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: hebernar <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/04 14:50:51 by hebernar          #+#    #+#             */
/*   Updated: 2019/10/04 14:50:53 by hebernar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int		ft_size(unsigned char nb, int base)
{
	int i;
...
static char		*ft_end(unsigned char nb, char *ret, t_pf *stct, int i)
{
	int k;
...
static char		*ft_middle(unsigned char nb, char *ret, t_pf *stct, int i)
{
	int j;
...
static char		*ft_begin(unsigned char nb, char *ret, t_pf *stct, int i)
{
